...
{
    // Le contenu d'un dossier est une liste d'éléments Objet.
    private ArrayList<Objet> contenu;

    /**
     * Constructor for objects of class Dossier
     */
    // Création d'un dossier avec un nom et une liste d'éléments Objet.
    ...
    {
        if(obj != null && this != obj)  // On vérifie que l'objet n'est pas null et qu'il ne s'agit pas de lui même.
        {
